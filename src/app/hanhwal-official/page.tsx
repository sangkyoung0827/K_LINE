...
export default async function HanhwalOfficialPage() {
    ...
    <OfficialShell>
      <section className="grid gap-6">
        ...
        <div className="mx-auto w-full max-w-5xl pt-2 text-center">
          <HanhwalPermissionRequestCard role={access.role} />
        </div>
      </section>
    </OfficialShell>
  );
    ...
    <>
      <section className="bg-navy py-16 text-paper md:py-24">
        <div className="mx-auto grid max-w-7xl gap-8 px-5 md:grid-cols-[1fr_auto] md:items-end md:px-8">
          ...
          <ClubMark id="hanhwal" size="xl" className="hidden border-4 border-white/70 shadow-lift md:inline-flex" />
        </div>
      </section>
