...
import { listReadableAlumniNotices } from "@/lib/hanhwalAlumni";
import { createPublicMetadata } from "@/lib/seo";

export const metadata: Metadata = createPublicMetadata({
  title: "HANHWAL Alumni Notices",
  description: "Public and role-aware notices for the HANHWAL Alumni network.",
  path: "/hanhwal-alumni/notices"
});

export default async function HanhwalAlumniNoticesPage() {
