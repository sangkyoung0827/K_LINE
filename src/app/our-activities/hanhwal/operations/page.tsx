    ...
    <section className="bg-paper py-10 sm:py-14 md:py-20">
      <div className="mx-auto max-w-5xl px-5 md:px-8">
        ...
        <p className="mt-4 max-w-3xl text-sm leading-7 text-ink/64">
          <I18nText
            en="Replace only semester-specific Hanhwal information without touching member records or established application history."
            ko="한활 회원 기록과 기존 신청 내역은 건드리지 않고 학기마다 바뀌는 운영 정보만 교체합니다."
          />
        </p>
