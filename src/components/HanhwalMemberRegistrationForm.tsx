...
function registrationToForm(registration: HanhwalMemberRegistration | null): FormState {
  if (!registration) {
    return emptyForm;
  }
...
function statusText(registration: HanhwalMemberRegistration, language: "en" | "ko") {
...
export function HanhwalMemberRegistrationForm() {
  ...
  useEffect(() => {
    ...
    fetch("/api/hanhwal/member-registration")
      .then((response) =>
  ...
  const submit = async (event: React.FormEvent<HTMLFormElement>) => {
    ...
    try {
      ...
      const response = await fetch("/api/hanhwal/member-registration", {
        method: "POST",
        headers: {
