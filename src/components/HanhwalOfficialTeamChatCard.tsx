    ...
    >
      {!editing ? (
        <>
          ...
          {teamChatUrl ? <div className="mt-5 grid w-full max-w-52 gap-3 sm:mt-6 sm:max-w-60">
            <img
              key={qrVersion}
          ...
          </div> : <p className="mt-5 text-sm text-ink/70">
            <I18nText en="The team chat link has not been configured yet." ko="팀채팅 링크가 아직 등록되지 않았습니다." />
          </p>}
        </>
      ) : (
