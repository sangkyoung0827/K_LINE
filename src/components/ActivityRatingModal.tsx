...
export function ActivityRatingModal() {
  ...
  return (
    <div className="fixed inset-0 z-[80] flex items-end justify-center bg-ink/20 px-3 pb-[max(0.75rem,env(safe-area-inset-bottom))] pt-3 backdrop-blur-[2px] sm:items-center sm:p-6">
      <section
        role="dialog"
        aria-modal="true"
        aria-labelledby="activity-rating-title"
        className="paper-panel relative w-full max-w-sm p-5 shadow-[0_28px_72px_rgba(31,42,68,0.24)] sm:p-7"
      >
        <button
          type="button"
          ...
          className="absolute right-3 top-3 inline-flex h-11 w-11 items-center justify-center rounded-full text-ink/52 transition hover:bg-hanji hover:text-ink disabled:opacity-50"
        >
        ...
        <h2 id="activity-rating-title" className="mt-3 pr-10 font-serif text-2xl font-semibold text-ink">
        ...
        <div className="mt-6 flex items-center justify-center gap-1" role="group" aria-label="Activity rating">
          {[1, 2, 3, 4, 5].map((rating) => (
            <button
              ...
              className="inline-flex h-11 w-11 items-center justify-center rounded-full transition active:scale-95 hover:scale-105 disabled:opacity-50"
              disabled={saving}
            >
              <Star
                aria-hidden
        ...
        <button
          ...
          className="mt-6 inline-flex min-h-12 w-full items-center justify-center rounded-xl bg-ink px-5 text-sm font-semibold text-paper transition hover:bg-navy disabled:cursor-not-allowed disabled:opacity-45"
        >
