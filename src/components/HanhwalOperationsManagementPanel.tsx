    ...
    <div className="grid gap-6">
      <section className="paper-panel p-5 md:p-8">
        ...
        <div className="mt-7 grid gap-5">
          ...
          <ChatSetting
            ...
            qrSrc={`/api/hanhwal/open-chat-qr?v=${qrVersion}`}
          />

          <ChatSetting
            title={korean ? "한활 문의 오픈채팅" : "HANHWAL inquiry chat"}
            description={
              korean
          ...
          <ChatSetting
            ...
            description={
              korean
                ? "한활 OFFICIAL의 정식회원 전용 링크와 QR입니다."
            ...
            qrSrc={`/api/hanhwal/official-team-qr?v=${qrVersion}`}
          />
        </div>
      ...
      <section className="border border-pine/20 bg-pine/10 p-5 text-sm leading-7 text-ink/68">
        <strong className="text-ink">
          {korean ? "활동 교체는 한활 활동 페이지에서 관리합니다." : "Activities are managed on the HANHWAL Activity page."}
        </strong>
        <p className="mt-1">
          {korean
