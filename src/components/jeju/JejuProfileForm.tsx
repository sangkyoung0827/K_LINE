...
export function JejuProfileForm() {
  ...
  async function save(event: FormEvent<HTMLFormElement>) {
    ...
    try {
      ...
      setMessage("Your Explore preferences have been saved.");
    } catch (error) {
  ...
  return (
    <JejuShell title="Your Explore preferences" description="This profile belongs only to Explore. It helps Woohyukmon make safer and more useful Jeju suggestions.">
      <section className="mx-auto max-w-4xl border border-[#0d5962]/12 bg-white/82 p-4 sm:p-6">
        <div className="border-b border-[#0d5962]/12 pb-4"><p className="text-xs font-bold uppercase text-[#0d5962]">Private profile</p><p className="mt-1 text-sm leading-6 text-[#4c6769]">Your profile is not added to ECC or Hanhwal. Allergies are used only to warn against unsuitable recommendations.</p></div>
