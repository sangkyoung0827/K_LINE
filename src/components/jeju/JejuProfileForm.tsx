...
export function JejuProfileForm() {
  ...
  async function save(event: FormEvent<HTMLFormElement>) {
    ...
    try {
      ...
      setMessage("Your Jeju preferences have been saved.");
    } catch (error) {
  ...
  return (
    <JejuShell title="Your Jeju preferences" description="This profile belongs only to Jeju Explorer. It helps Woohyukmon make safer and more useful Jeju suggestions.">
