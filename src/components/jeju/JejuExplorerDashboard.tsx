...
export function JejuExplorerDashboard() {
  ...
  return (
    <JejuShell
      ...
      actions={
        <Link href="/jeju/profile" className="inline-flex min-h-11 w-full items-center justify-center rounded-xl bg-[#0d5962] px-4 text-sm font-bold text-white transition hover:bg-[#073c44] sm:w-auto">
